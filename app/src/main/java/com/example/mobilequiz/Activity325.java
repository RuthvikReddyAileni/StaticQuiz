...
public class Activity325 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_325);
        ...
        Activity321.cround2 = MainActivity.score;
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (MainActivity.score < 10) {
                    Toast.makeText(Activity325.this, "You didn't qualify for round 3 as you scored less than 10.", Toast.LENGTH_LONG).show();
                    startActivity(new Intent(getApplicationContext(), Activity32.class));
                } else {
                    Toast.makeText(Activity325.this, "Congratulations , you are qualified to round 3 by scoring  " + MainActivity.score + " .", Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed() {
        AlertDialog.Builder altdial = new AlertDialog.Builder(Activity325.this);
