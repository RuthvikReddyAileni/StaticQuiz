...
public class Activity425 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_425);
        ...
        Activity421.javaround2 = MainActivity.score;
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(MainActivity.score < 10)
                {
                    Toast.makeText(Activity425.this, "You didn't for qualify round 3 as you scored less than 10.", Toast.LENGTH_LONG).show();
                    startActivity(new Intent(getApplicationContext(), Activity42.class));
                } else {
                    Toast.makeText(Activity425.this, "Congratulations  you qualified to round 3 by scoring "+ MainActivity.score +" .", Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed() {
        AlertDialog.Builder altdial = new AlertDialog.Builder(Activity425.this);
