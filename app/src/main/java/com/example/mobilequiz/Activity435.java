...
public class Activity435 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_435);
        ...
        Activity431.javaround3 = MainActivity.score;
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(MainActivity.score < 10)
                {
                    Toast.makeText(Activity435.this, "You didn't qualify round 3 as you scored less than 10.", Toast.LENGTH_LONG).show();
                    startActivity(new Intent(getApplicationContext(), Activity43.class));
                } else {
                    Toast.makeText(Activity435.this, "Congratulations !" , Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed() {
        AlertDialog.Builder altdial = new AlertDialog.Builder(Activity435.this);
