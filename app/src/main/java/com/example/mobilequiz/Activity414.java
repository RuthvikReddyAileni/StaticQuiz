...
public class Activity414 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_414);
        ...
        secans1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                secop1.setTextColor(Color.parseColor("#14E31C"));
                MainActivity.score =  MainActivity.score + 1 ;
            }
        });
        ...
        thirans2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                thirop2.setTextColor(Color.parseColor("#14E31C"));
                MainActivity.score =  MainActivity.score + 1 ;
            }
        });
        ...
        Activity41.javaround1 = MainActivity.score;
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(MainActivity.score < 10)
                {
                    Toast.makeText(Activity414.this, "You didn't qualify for round 2 as you scored less than 10.", Toast.LENGTH_LONG).show();
                    startActivity(new Intent(getApplicationContext(), Activity4.class));
                } else {
                    Toast.makeText(Activity414.this, "Congratulations , you are qualified to round 2 by scoring "+MainActivity.score+" .", Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed() {
        AlertDialog.Builder altdial = new AlertDialog.Builder(Activity414.this);
