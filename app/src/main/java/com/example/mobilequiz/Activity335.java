...
public class Activity335 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_335);
        ...
        Activity331.cround3 = MainActivity.score;
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(MainActivity.score < 10)
                {
                    Toast.makeText(Activity335.this, "You didn't qualify round 3 as you scored less than 10.", Toast.LENGTH_LONG).show();
                    startActivity(new Intent(getApplicationContext(), Activity33.class));
                } else {
                    Toast.makeText(Activity335.this, "Congratulations !", Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed() {
        AlertDialog.Builder altdial = new AlertDialog.Builder(Activity335.this);
